...
<div class="index_content">
    ...
    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal_reg">Registration</button>
                        ...
                        <div class="panel-body">
                            <form accept-charset="UTF-8" role="form" method="post" action="/register">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input required class="form-control" placeholder="Contact phone" name="phone"
                                               type="text">
                                    </div>
                                    <div class="form-group">
                                        <input required class="form-control" placeholder="E-mail" name="email"
